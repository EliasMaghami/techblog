...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/mic-icon.png
  AssetGenImage get micIcon => const AssetGenImage('assets/icons/mic-icon.png');

  /// File path: assets/icons/paar.png
  AssetGenImage get paar => const AssetGenImage('assets/icons/paar.png');

  /// File path: assets/icons/pen.png
  AssetGenImage get pen => const AssetGenImage('assets/icons/pen.png');

  /// List of all assets
  List<AssetGenImage> get values => [hashtagIcon, micIcon, paar, pen];
}
...
class $AssetsImageGen {
  ...
  /// File path: assets/image/fullstack.png
  AssetGenImage get fullstack =>
      const AssetGenImage('assets/image/fullstack.png');
